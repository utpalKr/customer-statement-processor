...
public class ValidationServiceImplTest {
    ...
    @InjectMocks
    ValidationServiceImpl theServiceImpl;
    ...
    public void shouldValidate() throws ValidationException {
        ...
        records.add(record1);
        validationResults = theServiceImpl.validate(records);

        Assert.assertNotNull(validationResults);
        Assert.assertEquals(4, validationResults.size());
        Assert.assertEquals("EndBalance Validation Failed", validationResults.get(0).getDescription());
        Assert.assertEquals("Unique transaction Validation Failed", validationResults.get(2).getDescription());
